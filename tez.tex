...
\kapaksayfasi			% kapak sayfası
\imzasayfasi			% imza sayfası
\tezbildirimsayfasi		% tez bildirim sayfası
...
\input{kisaltmalar}	% kısaltmalar
\input{semboller}	% semboller
